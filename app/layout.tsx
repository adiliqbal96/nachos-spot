  ...
  return (
    <html lang="da">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Oswald:wght@400;700&family=Barlow+Condensed:ital,wght@0,300;0,400;0,600;0,700;1,400;1,700&family=Barlow:wght@400;500&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>{children}</body>
